...
export const typographyDefinitions = {
  fontFamily: getFontFamily('Pretendard'),
  htmlFontSize: 16,
  allVariants: {
    color: palette.text.primary,
  },
  h1: {
    fontFamily: getFontFamily('Pretendard-Medium'),
    fontSize: 56,
    lineHeight: 68 / 56,
    letterSpacing: 0,
  },
  ...
  h3: {
    fontFamily: getFontFamily('Pretendard-Bold'),
    fontSize: 24,
    lineHeight: 36 / 24,
    letterSpacing: 0,
  },
  ...
  body1: {
    fontFamily: getFontFamily('Pretendard-Light'),
    fontSize: 18,
    lineHeight: 28 / 18,
    letterSpacing: 0,
  },
  ...
  components: {
    ...
    MuiButton: {
      styleOverrides: {
        ...
        outlined: {
          color: palette.text.primary,
          borderColor: palette.border.border04,
          borderWidth: 2,
          padding: '14px 26px',
          ':hover': {
            color: palette.text.primary,
